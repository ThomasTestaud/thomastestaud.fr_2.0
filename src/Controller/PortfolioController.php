...
class PortfolioController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        $articles = [
            ...
            [
                'title' => 'WWCP',
                'description' => 'Wrap_WebApp_Into_client.println(""); est une application simple qui sert à convertir le code de web apps pour mon serveur web en C++ sur mon ESP32.',
            ...
            [
                'title' => 'DNT V.C.',
                'description' => "Créé pour équipe de rédacteur.e.s, DNT VisualChecker est une app de traitement de texte qui sert à éditer les balises dnt (do not translate), utiles dans les logiciels de TAO (Traduction Assistée par Ordinateur). /!\Noter que le rendu sur ce site empêche l'aplication de fonctionner correctement./!\ ",
